...
// --- Styles ---
import "@/components/tiptap-content-manage/content-manage.scss";
...
export const ContentManager = React.forwardRef(({ viewer = false, content, callbackUpload }: ContentManagerProps, ref: React.Ref<{ editor: Editor | null }>) => {
  ...
  return (
    <EditorContext.Provider value={{ editor }}>
      ...
      <div className={` ${viewer ? 'content-wrapper-not-editable' : 'content-wrapper'} ${viewer ? '' : 'border'}  ${isDarkMode ? "bg-gray-950 border-blue-950" : "bg-white border-gray-100"} `}>
        <EditorContent
          readOnly={viewer}
          editor={editor}
          role="presentation"
